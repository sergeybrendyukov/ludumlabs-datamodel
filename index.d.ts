export declare enum EErrorCode {
    ...
    ERROR_API_AUTH_NONVERIFIED = "ERROR_API_AUTH_NONVERIFIED",
    ERROR_API_AUTH_DUPLICATEID = "ERROR_API_AUTH_DUPLICATEID",
    ERROR_API_AUTH_NOTENOUGHPRIVILEGE = "ERROR_API_AUTH_NOTENOUGHPRIVILEGE",
    ERROR_API_AUTH_NOTENOUGHOWNERSHIP = "ERROR_API_AUTH_NOTENOUGHOWNERSHIP",
    ERROR_API_AUTH_BADMANAGEMODE = "ERROR_API_AUTH_BADMANAGEMODE",
